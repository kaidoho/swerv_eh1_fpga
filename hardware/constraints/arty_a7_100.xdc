...
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { jtag_nrst }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
...
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
